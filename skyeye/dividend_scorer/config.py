...
SCORE_PERCENTILE_WINDOW = TRADING_DAYS_A_YEAR * 2
SCORE_PERCENTILE_MIN_DATA = 120
SCORE_BUY_PERCENTILE = 0.2
SCORE_SELL_PERCENTILE = 0.8
WEIGHT_PRIOR_BLEND = 0.7
WEIGHT_DYNAMIC_DIAGNOSTIC = True

CONFIDENCE_EXTREME_LOW = 0.1
CONFIDENCE_EXTREME_HIGH = 0.9

CACHE_DB_PATH = "~/.rqalpha/dividend_scorer/cache.db"
SYNC_DEFAULT_START_DATE = "2020-01-01"
SYNC_OVERLAP_TRADING_DAYS = 10
CACHE_STALE_DAYS = 3
...
SAMPLE_OUT_YEARS = 1
PARAMS_VERSION = "v1_20260321_shrunk_07"
