...
# 回测使用方法
# env UV_CACHE_DIR=/tmp/uv-cache MPLCONFIGDIR=/tmp/mplconfig uv run python skyeye/strategy_scorer.py skyeye/examples/dividend_low_vol_score_strategy_history_aware.py --mod dividend_scorer

# Used by skyeye/strategy_scorer.py to choose default rolling-score windows.
