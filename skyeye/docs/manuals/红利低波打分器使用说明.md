...
- [dividend_score_vs_price_plot_strategy.py](../../examples/dividend_score_vs_price_plot_strategy.py)
...
```bash
uv run rqalpha run \
  -f skyeye/examples/dividend_score_vs_price_plot_strategy.py \
  -s 2019-01-18 \
  -e 2026-03-06 \
  --account stock 100000 \
  -fq 1d \
