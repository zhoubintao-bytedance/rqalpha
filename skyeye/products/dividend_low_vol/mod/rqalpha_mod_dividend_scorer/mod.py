...
from skyeye.products.dividend_low_vol.scorer.config import WEIGHT_DYNAMIC_DIAGNOSTIC, WEIGHT_PRIOR_BLEND
...
class DividendScorerMod(AbstractMod):
    ...
    def start_up(self, env, mod_config):
        ...
        self._scorer = DividendScorer(
            ...
            prior_blend=WEIGHT_PRIOR_BLEND if prior_blend is None else prior_blend,
            dynamic_diagnostic=getattr(mod_config, "dynamic_diagnostic", WEIGHT_DYNAMIC_DIAGNOSTIC),
        )
