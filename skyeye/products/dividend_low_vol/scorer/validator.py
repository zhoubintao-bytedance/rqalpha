...
from skyeye.products.dividend_low_vol.scorer.config import LABEL_WINDOW_N, SUBSAMPLE_INTERVAL_S, VALUATION_FEATURES
...
class Validator(object):
    ...
    def _load_strategy_scorer():
        from skyeye.evaluation import rolling_score
