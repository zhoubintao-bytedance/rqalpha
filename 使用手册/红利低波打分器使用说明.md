...
- [dividend_low_vol_score_strategy_history_aware.py](../rqalpha/examples/dividend_low_vol_score_strategy_history_aware.py)
...
```bash
uv run rqalpha run \
  -f rqalpha/examples/dividend_low_vol_score_strategy_history_aware.py \
  -s 2024-01-01 \
  -e 2025-12-31 \
